...
const projects: Project[] = [
  { 
    ...
    imageUrl: `${GITHUB_IMG_BASE}p1.jpg`, 
    year: 2024,
    client: 'Privado',
    location: 'CDMX, MX'
  },
  { 
    ...
    imageUrl: `${GITHUB_IMG_BASE}p2.jpg`, 
    year: 2023,
  ...
  { 
    ...
    imageUrl: `${GITHUB_IMG_BASE}p3.jpg`, 
    year: 2024,
  ...
  { 
    ...
    imageUrl: `${GITHUB_IMG_BASE}p4.jpg`, 
    year: 2023,
    client: 'Privado',
    location: 'Monterrey, NL'
  },
  { 
    ...
    imageUrl: `${GITHUB_IMG_BASE}p5.jpg`, 
    year: 2024,
  ...
  { 
    ...
    imageUrl: `${GITHUB_IMG_BASE}p6.jpg`, 
    year: 2024,
