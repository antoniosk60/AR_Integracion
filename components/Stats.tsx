        ...
        <div className="flex flex-col lg:flex-row gap-20 items-center">
          <div className="lg:w-1/2">
            ...
            <div className="grid grid-cols-2 gap-10">
              ...
              <div className="group">
                <span className="text-6xl font-black text-white block mb-2 group-hover:text-amber-500 transition-colors">98%</span>
                <div className="w-10 h-1 bg-amber-500 mb-3 rounded-full"></div>
                <span className="text-slate-400 font-bold text-sm uppercase tracking-widest">Satisfacción</span>
              </div>
              <div className="group">
                <span className="text-6xl font-black text-white block mb-2 group-hover:text-amber-500 transition-colors">0</span>
                <div className="w-10 h-1 bg-amber-500 mb-3 rounded-full"></div>
                <span className="text-slate-400 font-bold text-sm uppercase tracking-widest">Incidentes</span>
              </div>
            </div>
                ...
                <div className="h-[350px] w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={data} margin={{ top: 20, right: 10, left: -20, bottom: 0 }}>
                      ...
                      />
                      <Bar name="Proyectos Entregados" dataKey="proyectos" radius={[8, 8, 0, 0]} barSize={40}>
